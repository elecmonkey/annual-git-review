...
>
  ...
  >
    ...
    <div class="space-y-6">
      ...
      <div class="space-y-2">
        <div class="flex items-center justify-between">
          <h3 class="text-sm font-medium uppercase tracking-wider text-white/50">Show Footer</h3>
          <label class="relative inline-flex cursor-pointer items-center">
        ...
        <p class="text-xs text-white/40">
          Display "Generated by annual-git-review" on slides.
        </p>
      </div>
      ...
      <div class="space-y-2">
        <div class="flex items-center justify-between">
          <h3 class="text-sm font-medium uppercase tracking-wider text-white/50">Show Snow</h3>
          <label class="relative inline-flex cursor-pointer items-center">
        ...
        <p class="text-xs text-white/40">
          Toggle snowflakes on the summary slide.
        </p>
      </div>
    </div>
  </div>
